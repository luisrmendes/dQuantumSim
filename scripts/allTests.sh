...
# 3 qubit tests
python scripts/test.py myqasmTests/q3_grovers.myqasm 3 "50 50 0"
python scripts/test.py myqasmTests/q3_test1.myqasm 3 "100 50 100"
...
# 5 qubit tests
python scripts/test.py myqasmTests/q5_test1.myqasm 4 "100 0 0 0 0"
